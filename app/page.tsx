  ...
  return (
    <main className="flex flex-col items-center justify-center mt-0">
      <div className="bg-[#1a1a1a] w-[80%] h-auto mx-auto rounded-2xl mt-25 p-5 pb-10 text-white flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center gap-3.5 md:gap-5">
          <button className="bg-[#313131] p-2 w-[300px] font-bold rounded-2xl hover:bg-lime-500 cursor-pointer ease-in-out duration-300 md:w-[500px] md:text-2xl">
            GitHub
          </button>
          <button className="bg-[#313131] p-2 w-[300px] font-bold rounded-2xl hover:bg-lime-500 cursor-pointer ease-in-out duration-300 md:w-[500px] md:text-2xl">
            Frontend Mentor
